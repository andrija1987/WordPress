			...
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				if( $link ) $output .= '<a href="'. $link .'" '. $target .'>';
					...
					$output .= '<div class="photo_wrapper">';
						$output .= '<img class="scale-with-grid" src="'. $image .'" alt="'. $title .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .' />';
					$output .= '</div>';
...
if( ! function_exists( 'sc_sliding_box' ) )
{
	function sc_sliding_box( $attr, $content = null )
	{
		...
		// width & height
		$attachmentID	= mfn_get_attachment_id_url( $image );
		$width 			= 'width="'.mfn_get_attachment_dimensions( $attachmentID, 'width' ).'"';
		$height 		= 'height="'.mfn_get_attachment_dimensions( $attachmentID, 'height' ).'"';
		// '. $width .' '. $height .'
		...
		$output = '<div class="sliding_box">';
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				if( $link ) $output .= '<a href="'. $link .'" '. $target .'>';
					...
					$output .= '<div class="photo_wrapper">';
						$output .= '<img class="scale-with-grid" src="'. $image .'" alt="'. $title .'" '. $width .' '. $height .'/>';
					$output .= '</div>';
		...
		$output = '<div class="story_box '. $style .'">';
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				if( $link ) $output .= '<a href="'. $link .'" '. $target .'>';
					...
					$output .= '<div class="photo_wrapper">';
						$output .= '<img class="scale-with-grid" src="'. $image .'" alt="'. strip_tags( $title ) .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'/>';
					$output .= '</div>';
		...
		$output = '<div class="promo_box '. $border .'">';
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				$output .= '<div class="promo_box_wrapper promo_box_'. $position .'">';
					...
					$output .= '<div class="photo_wrapper">';
						if( $image ) $output .= '<img class="scale-with-grid" src="'. $image .'" alt="'. $title .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'>';
					$output .= '</div>';
			...
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
					...
					if( $link ) $output .= '<a href="'. $link .'" '. $target .'>';
						$output .= '<div class="image">';
							$output .= '<img src="'. $image .'" class="scale-with-grid" alt="'. $title .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'>';
		...
		$output = '<div class="pricing-box '. $classes .'">';
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				...
				$output .= '<div class="plan-header">';
					...
					if( $image ){
						$output .= '<div class="image">';
							$output .= '<img src="'. $image .'" alt="'. $title .'" '. $width .' '. $height .'/>';
						$output .= '</div>';
					}
	...
	function sc_chart( $attr, $content = null )
	{
		...
		$output = '<div class="chart_box">';
			$output .= '<div class="chart" data-percent="'. intval($percent) .'" data-color="'.  $color .'">';
				if( $image ){
					$output .= '<div class="image"><img class="scale-with-grid" src="'. $image .'" alt="'. $percent .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .' /></div>';
				} elseif( $icon ){
		...
		$output = '<div class="counter counter_'. $type .' '. $animate_math .'">';
			if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
				...
				$output .= '<div class="icon_wrapper">';
					if( $image ){
						$output .= '<img src="'. $image .'" alt="'. $title .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'/>';
					} elseif( $icon ){
...
if( ! function_exists( 'sc_image' ) )
{
	function sc_image( $attr, $content = null )
	{
		...
		if( ! $width ) 	$width 	= mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $src ), 'width' );
		if( ! $height ) $height = mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $src ), 'height' );
...
if( ! function_exists( 'sc_hover_box' ) )
{
	function sc_hover_box( $attr, $content = null )
	{
		...
		$output = '<div class="hover_box">';
			if( $link ) $output .= '<a href="'. $link .'" '. $target .'>';
				$output .= '<div class="hover_box_wrapper">';
					$output .= '<img class="visible_photo scale-with-grid" src="'. $image .'" alt="'. $alt .'" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'/>';
					$output .= '<img class="hidden_photo scale-with-grid" src="'. $image_hover .'" alt="'. $alt .'" />';
				$output .= '</div>';
			if( $link ) $output .= '</a>';
		$output .= '</div>'."\n";
		...
		if( $animate ) $output .= '<div class="animate" data-anim-type="'. $animate .'">';
			$output .= '<div class="icon_box icon_position_'. $icon_position .' '. $border .'">';
				if( $link ) $output .= '<a class="'. $class .'" href="'. $link .'" '. $target .' '. $rel .'>';
					...
					if( $image ){
						$output .= '<div class="image_wrapper">';
							$output .= '<img src="'. $image .'" alt="'. $title .'" class="scale-with-grid" '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'width', 1 ) .' '. mfn_get_attachment_dimensions( mfn_get_attachment_id_url( $image ), 'height', 1 ) .'/>';
						$output .= '</div>';
					} else {
						$output .= '<div class="icon_wrapper">';
